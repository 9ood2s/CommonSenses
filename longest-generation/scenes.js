(function(){
  ...
  window.ACT_SCENES={
    ...
    5:{
      ...
      alt:'쌀가마가 쌓인 관아 창고 앞에서 농민과 상인, 관리가 저울과 장부를 둘러싸고 공물 부담을 다투는 모습',
    ...
    10:{
      ...
      alt:'병자호란 뒤 속환소에서 포로 가족들이 장부와 저울 앞에 줄을 서고 동전과 물건을 모으는 모습',
    ...
    12:{
      ...
      alt:'회복된 마을의 공동 창고와 장터, 서당에서 아이들과 어른들이 곡식과 약재, 장부와 배움을 이어 가는 모습',
